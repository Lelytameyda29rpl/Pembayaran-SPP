          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form action="aksi.php" method="post">
                ...
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg"  placeholder="Masukkan Password" name="password">
                </div>
                <div class="mt-3">
                ...
                <div class="text-center mt-4 fw-light">
                  Are You Student ? <a href="siswa/login_siswa.php" class="text-primary">Here</a>
                </div>
              </form>
            </div>
          </div>
