<?php 
$edit=$mysqli->query("select*from pembayaran,siswa,spp where pembayaran.nisn=siswa.nisn and siswa.id_spp=spp.id_spp and pembayaran.id_pembayaran='$_GET[id_pembayaran]'");
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="?pembayaran=update">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="id_pembayaran" placeholder="Masukkan Id Pembayaran" name="id_pembayarandisabled" value="<?php echo $e['id_pembayaran'];?>" disabled>
                      <input type="hidden" class="form-control" id="id_pembayaran" placeholder="Masukkan Id Pembayaran" name="id_pembayaran" value="<?php echo $e['id_pembayaran'];?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="tgl_bayar" placeholder="Masukkan Tanggal Bayar" name="tgl_bayar" value="<?php echo $e['tgl_bayar'];?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="tahun_dibayar" placeholder="Masukkan Tahun Di Bayar" name="tahun_dibayar" value="<?php echo $e['tahun_dibayar'];?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="jumlah_bayar" placeholder="Masukkan Jumlah Bayar" name="jumlah_bayar" value="<?php echo $e['jumlah_bayar'];?>">
                    </div>
